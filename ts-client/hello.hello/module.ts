...
export { GenesisState, Params, MsgUpdateParams, QuerySayHelloRequest, MsgUpdateParamsResponse, QueryParamsRequest, QueryParamsResponse, QuerySayHelloResponse };
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		genesisState({ value }: genesisStateParams): EncodeObject {
			try {
				return { typeUrl: "/hello.hello.GenesisState", value: GenesisState.fromPartial( value ) }  
			} catch (e: any) {
		...
		params({ value }: paramsParams): EncodeObject {
			try {
				return { typeUrl: "/hello.hello.Params", value: Params.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgUpdateParams({ value }: msgUpdateParamsParams): EncodeObject {
			try {
				return { typeUrl: "/hello.hello.MsgUpdateParams", value: MsgUpdateParams.fromPartial( value ) }  
			} catch (e: any) {
		...
		querySayHelloRequest({ value }: querySayHelloRequestParams): EncodeObject {
			try {
				return { typeUrl: "/hello.hello.QuerySayHelloRequest", value: QuerySayHelloRequest.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgUpdateParamsResponse({ value }: msgUpdateParamsResponseParams): EncodeObject {
			try {
				return { typeUrl: "/hello.hello.MsgUpdateParamsResponse", value: MsgUpdateParamsResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryParamsRequest({ value }: queryParamsRequestParams): EncodeObject {
			try {
				return { typeUrl: "/hello.hello.QueryParamsRequest", value: QueryParamsRequest.fromPartial( value ) }  
			} catch (e: any) {
		...
		queryParamsResponse({ value }: queryParamsResponseParams): EncodeObject {
			try {
				return { typeUrl: "/hello.hello.QueryParamsResponse", value: QueryParamsResponse.fromPartial( value ) }  
			} catch (e: any) {
		...
		querySayHelloResponse({ value }: querySayHelloResponseParams): EncodeObject {
			try {
				return { typeUrl: "/hello.hello.QuerySayHelloResponse", value: QuerySayHelloResponse.fromPartial( value ) }  
			} catch (e: any) {
